...
* [`viash run`](#viash-run): Run a viash component (mainly for development purposes).
* [`viash test`](#viash-test): Run the tests of a viash component (for development purposes).
* [`viash export`](#viash-export): Export a component to an executable using the desired back-end.
