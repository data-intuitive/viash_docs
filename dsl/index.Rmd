...
Since version 0.4.0, viash supports modifying a [viash config](/config) YAML 
at runtime using a custom DSL. This allows making dynamic changes to your projects.
All viash subcommands have support for the DSL through the `-c` parameter.
