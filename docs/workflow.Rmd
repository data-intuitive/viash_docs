...
[^1]: Please note that `viash` currently does not have a notion of a build resource of runtime resource. This means that all resources are currently copied along to all targets. We will tackle this in a future version of `viash`.
