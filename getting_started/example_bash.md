...
```
    ...
    ## /tmp/viash-run-hello_world-r8ovnm: line 7: ﻿#!/usr/bin/env: No such file or directory
...
```
    ...
    ## /viash_automount/tmp//viash-run-hello_world-nJpJkI: line 7: ﻿#!/usr/bin/env: No such file or directory
...
```
    ...
    ## /viash_automount/tmp//viash-run-hello_world-eafJoG: line 7: ﻿#!/usr/bin/env: No such file or directory
...
```
    ...
    ## Running tests in temporary directory: '/tmp/viash_test_hello_world12275092368724274633'
    ## ====================================================================
    ## +/tmp/viash_test_hello_world12275092368724274633/build_executable/hello_world ---setup
    ## > docker pull bash:4.0
    ## 4.0: Pulling from library/bash
    ## Digest: sha256:2fb822817a6e1e42030bf163ca61c997441ec20ebb6adef52643d8c33f01bc6a
    ## Status: Image is up to date for bash:4.0
    ## docker.io/library/bash:4.0
    ## ====================================================================
    ## +/tmp/viash_test_hello_world12275092368724274633/test_test.sh/test.sh
    ## >>> Checking whether output is correct
    ## + echo '>>> Checking whether output is correct'
    ## + ./hello_world I am 'viash!'
    ## /tmp/viash-run-hello_world-LCMhjc: line 7: ﻿#!/usr/bin/env: No such file or directory
    ...
    ## + ./hello_world
    ## /tmp/viash-run-hello_world-KaIggd: line 7: ﻿#!/usr/bin/env: No such file or directory
    ## + [[ ! -f output2.txt ]]
    ...
    ## /tmp/viash-run-hello_world-FCEbmb: line 7: ﻿#!/usr/bin/env: No such file or directory
    ## + [[ ! -f output3.txt ]]
...
[Nextflow](../config/platform-nextflow). If no platforms are specified,
a native platform with no system requirements is assumed.
