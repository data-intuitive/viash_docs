...
## Demonstration
Given the files and meta files in the [examples/hello_world_r](https://github.com/data-intuitive/viash_docs/tree/master/examples/hello_world_r) directory, we demonstrate the functionality of viash in running the component 
