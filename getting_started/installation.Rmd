...
- viash is developed in [Scala 2.12](https://www.scala-lang.org/), so you'll need an [Oracle Java SE Development Kit 8 installation](https://www.oracle.com/java/technologies/javase/javase-jdk8-downloads.html) in order to use it.

## Install

### Packaged Release

To install viash, download the [latest release](https://github.com/data-intuitive/viash/releases/latest) and save it to the `~/bin` folder or any other directory that is specified your `$PATH` variable.

Here's a one-liner command to download the latest release of viash to your `~/bin` folder:
...
- [Oracle Java SE Development Kit 8 installation](https://www.oracle.com/java/technologies/javase/javase-jdk8-downloads.html)
