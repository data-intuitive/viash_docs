...
- viash is developed in [Scala 2.12](https://www.scala-lang.org/), so you'll need an [Oracle Java 8 installation](https://www.oracle.com/java/technologies/javase/javase-jdk8-downloads.html) in order to use it.
