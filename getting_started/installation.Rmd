...
To install viash, download the [latest release](https://github.com/data-intuitive/viash/releases) and save it to the `~/bin` folder or any other directory that is specified your `$PATH` variable.
