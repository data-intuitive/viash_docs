...
These arguments are passed on to the **resources**. In this case, there's a single reference to a file named [`script.sh`](http://www.data-intuitive.com/viash_docs/examples/hello_world_py/script.sh). This file is the 'brain' of the component, it's small Bash script which prints out two environment values: `par_input` and `par_greeter`: 
