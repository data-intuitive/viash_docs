...
Sometimes you just need one tool wrapped in a container. That's where `viash` can help. Using the CLI interface, one can export the component spec to a runnable (Docker) script.
